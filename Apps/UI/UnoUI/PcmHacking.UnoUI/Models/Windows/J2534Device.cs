...
namespace PcmHacking.UnoUI.Models.Windows {
    /// <summary>
    /// This class encapsulates all code that is unique to the AVT 852 interface.
    /// </summary>
    ///
    class J2534Device : PcmHacking.Device
    {
        /// <summary>
        ...
        public J2534Device(J2534DotNet.J2534Device jport, ILogger logger) : base(logger)
        {
            ...
            this.MaxSendSize = 1024 + 12;    // J2534 Standard is 4KB
            this.MaxReceiveSize = 1024 + 12; // J2534 Standard is 4KB
        ...
        {
            TimeoutScenario previousTimeout = this.currentTimeoutScenario;
            this.currentTimeoutScenario = scenario;
            return Task.FromResult(previousTimeout);
        }
        ...
        private Response<J2534Err> SendNetworkMessage(Message message, TxFlag Flags)
        {
            ...
            if (OBDError != J2534Err.STATUS_NOERROR)
            {
                ...
                this.Logger.AddDebugMessage($"J2534 Write error: {OBDError}");
        ...
        public bool IsLoaded
        {
            get 
            {
                try
                {
                    ...
                    {
                        if (dll.FileName == J2534Port.LoadedDevice.FunctionLibrary && this.J2534Port.Functions.IsInstanceValid())
                        {
                            return true;
                        }
                    }
