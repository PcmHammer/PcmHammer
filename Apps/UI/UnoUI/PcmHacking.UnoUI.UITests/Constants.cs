namespace PcmHacking.UnoUI.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "net.PcmHacking.Uno";
    public readonly static string AndroidAppName = "net.PcmHacking.Uno";
