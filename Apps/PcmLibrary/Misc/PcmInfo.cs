        ...
        public bool PCMInfo(PcmType pcmType)
        {
            ...
            switch (pcmType)
            {
                ...
                case PcmType.E92:
                    ...
                    this.IsSupported = true;
                    this.IsSupportedRead = true;
                    this.IsSupportedWrite = false;   // read first; write still to be ported
                    this.BusProtocol = BusProtocol.Can500k;
                    ...
                    // NEW 40-bit (5-byte) seed/key security. The algorithm is external: the tool
                    // shows the seed and the user enters the key, cached per PCM type + seed.
                    this.KeyAlgorithm = 0;
